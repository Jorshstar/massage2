  ...
  return (
    ...
    >
      ...
      <div className="w-full md:w-3/5 p-6 md:p-8 flex flex-col justify-between bg-white">
        <div>
          <h3 className="text-2xl font-semibold mb-3 text-[#3a5a40]">{name}</h3>
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          className="inline-block self-start px-6 py-3 bg-[#588157] text-white rounded-md hover:bg-[#3a5a40] transition-colors duration-300 shadow-md"
        >
